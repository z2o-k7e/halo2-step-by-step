...
impl <F: Field> Circuit<F> for MyCircuit<F> {
    ...
    fn synthesize(&self, config: Self::Config, mut layouter: impl Layouter<F>) -> Result<(), Error> {
        ...
        let out = chip.assign(layouter.namespace(|| "complex ship"), self.a, self.b, self.c)?;
        //expose public
...
mod tests {
    ...
    fn plot_chap_2_exercise_5(){
        ...
        let root = BitMapBackend::new("./circuit_layouter_plots/chap_2_exercise_5.png", (1024, 768)).into_drawing_area();
